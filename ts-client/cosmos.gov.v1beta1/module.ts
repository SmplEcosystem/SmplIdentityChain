...
export { TallyResult, MsgSubmitProposalResponse, MsgDeposit, QueryProposalRequest, QueryProposalsRequest, QueryProposalsResponse, DepositParams, TallyParams, MsgVoteResponse, QueryVotesResponse, QueryDepositResponse, QueryDepositsResponse, VotingParams, TextProposal, Deposit, MsgVote, MsgVoteWeightedResponse, QueryProposalResponse, QueryParamsResponse, QueryDepositRequest, WeightedVoteOption, GenesisState, MsgSubmitProposal, MsgVoteWeighted, MsgDepositResponse, QueryVotesRequest, QueryParamsRequest, QueryDepositsRequest, Proposal, Vote, QueryVoteResponse, QueryTallyResultRequest, QueryVoteRequest, QueryTallyResultResponse };
