...
export { WeightedVoteOption, QueryProposalsRequest, QueryDepositResponse, MsgVoteWeightedResponse, TextProposal, QueryTallyResultRequest, QueryVoteRequest, QueryParamsResponse, QueryDepositRequest, QueryDepositsResponse, QueryProposalsResponse, TallyParams, MsgSubmitProposalResponse, MsgDepositResponse, GenesisState, QueryVotesRequest, QueryVotesResponse, MsgVoteResponse, TallyResult, Vote, MsgVote, Proposal, VotingParams, QueryProposalRequest, QueryVoteResponse, QueryDepositsRequest, MsgVoteWeighted, MsgSubmitProposal, MsgDeposit, DepositParams, QueryProposalResponse, QueryParamsRequest, QueryTallyResultResponse, Deposit };
