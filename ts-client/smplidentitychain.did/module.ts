...
import { DataWithSequence as typeDataWithSequence} from "./types"

export { DidDocumentMetadata, Params, VerificationRelationship, QueryResolveDidRequest, MsgUpsertDid, MsgUpdateParams, GenesisState, QueryResolveDidResponse, QueryParamsResponse, VerificationMethod, Service, DIDDocument, MsgUpdateParamsResponse, QueryParamsRequest, DidInfo, MsgUpsertDidResponse, ResolutionOptions, DidResolutionMetadata };
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						DataWithSequence: getStructure(typeDataWithSequence.fromPartial({})),
