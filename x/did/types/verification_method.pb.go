...
type VerificationMethod struct {
	...
	PublicKeyBase58 string   `protobuf:"bytes,5,opt,name=publicKeyBase58,proto3" json:"publicKeyBase58,omitempty"`
}
...
func (*VerificationMethod) Descriptor() ([]byte, []int) {
	return fileDescriptor_e935fd04b38cd41f, []int{0}
}
...
func init() {
	proto.RegisterType((*VerificationMethod)(nil), "smplidentitychain.did.VerificationMethod")
}

func init() {
	proto.RegisterFile("smplidentitychain/did/verification_method.proto", fileDescriptor_e935fd04b38cd41f)
}

var fileDescriptor_e935fd04b38cd41f = []byte{
	...
	,
	...
	0xc2, 0xf3, 0x84, 0x7a, 0xd9, 0x19, 0x1c, 0x46, 0x15, 0xe0, 0x50, 0x02, 0x39, 0xbf, 0x38, 0x89,
	0x0d, 0x1c, 0x30, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xd2, 0xa5, 0xaf, 0x3b, 0x4b, 0x01,
	0x00, 0x00,
}
...
func (m *VerificationMethod) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PublicKeyBase58) > 0 {
		...
		i = encodeVarintVerificationMethod(dAtA, i, uint64(len(m.PublicKeyBase58)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.PublicKeyHex) > 0 {
		...
		i = encodeVarintVerificationMethod(dAtA, i, uint64(len(m.PublicKeyHex)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Controller) > 0 {
		for iNdEx := len(m.Controller) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintVerificationMethod(dAtA, i, uint64(len(m.Controller[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	...
	if len(m.Id) > 0 {
		i -= len(m.Id)
		copy(dAtA[i:], m.Id)
		i = encodeVarintVerificationMethod(dAtA, i, uint64(len(m.Id)))
		i--
		dAtA[i] = 0xa
	}
