...
func init() {
	...
	md_Service = File_smplidentitychain_did_service_proto.Messages().ByName("Service")
...
func (x *Service) slowProtoReflect() protoreflect.Message {
	mi := &file_smplidentitychain_did_service_proto_msgTypes[0]
...
func (x *fastReflection_Service) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "smplidentitychain.did.Service.id":
		return x.Id != ""
	case "smplidentitychain.did.Service.type":
		return x.Type_ != ""
	case "smplidentitychain.did.Service.service_endpoint":
		return x.ServiceEndpoint != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: smplidentitychain.did.Service"))
		}
		panic(fmt.Errorf("message smplidentitychain.did.Service does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Service) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message smplidentitychain.did.Service does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Service) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "smplidentitychain.did.Service.id":
		panic(fmt.Errorf("field id of message smplidentitychain.did.Service is not mutable"))
	case "smplidentitychain.did.Service.type":
		panic(fmt.Errorf("field type of message smplidentitychain.did.Service is not mutable"))
	case "smplidentitychain.did.Service.service_endpoint":
		panic(fmt.Errorf("field service_endpoint of message smplidentitychain.did.Service is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: smplidentitychain.did.Service"))
		}
...
func (x *fastReflection_Service) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in smplidentitychain.did.Service", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: smplidentitychain/did/service.proto
...
func (*Service) Descriptor() ([]byte, []int) {
	return file_smplidentitychain_did_service_proto_rawDescGZIP(), []int{0}
}
...
var File_smplidentitychain_did_service_proto protoreflect.FileDescriptor

var file_smplidentitychain_did_service_proto_rawDesc = []byte{
	0x0a, 0x23, 0x73, 0x6d, 0x70, 0x6c, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x63, 0x68,
	0x61, 0x69, 0x6e, 0x2f, 0x64, 0x69, 0x64, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x15, 0x73, 0x6d, 0x70, 0x6c, 0x69, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x64, 0x69, 0x64, 0x22, 0x58, 0x0a, 0x07,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x45, 0x6e,
	0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x42, 0xc6, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x73,
	0x6d, 0x70, 0x6c, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x63, 0x68, 0x61, 0x69, 0x6e,
	0x2e, 0x64, 0x69, 0x64, 0x42, 0x0c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f,
...
var (
	file_smplidentitychain_did_service_proto_rawDescOnce sync.Once
	file_smplidentitychain_did_service_proto_rawDescData = file_smplidentitychain_did_service_proto_rawDesc
)

func file_smplidentitychain_did_service_proto_rawDescGZIP() []byte {
	file_smplidentitychain_did_service_proto_rawDescOnce.Do(func() {
		file_smplidentitychain_did_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_smplidentitychain_did_service_proto_rawDescData)
	})
	return file_smplidentitychain_did_service_proto_rawDescData
}

var file_smplidentitychain_did_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_smplidentitychain_did_service_proto_goTypes = []interface{}{
	(*Service)(nil), // 0: smplidentitychain.did.Service
}
var file_smplidentitychain_did_service_proto_depIdxs = []int32{
...
func init() { file_smplidentitychain_did_service_proto_init() }
func file_smplidentitychain_did_service_proto_init() {
	if File_smplidentitychain_did_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_smplidentitychain_did_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_smplidentitychain_did_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_smplidentitychain_did_service_proto_goTypes,
		DependencyIndexes: file_smplidentitychain_did_service_proto_depIdxs,
		MessageInfos:      file_smplidentitychain_did_service_proto_msgTypes,
	}.Build()
	File_smplidentitychain_did_service_proto = out.File
	file_smplidentitychain_did_service_proto_rawDesc = nil
	file_smplidentitychain_did_service_proto_goTypes = nil
	file_smplidentitychain_did_service_proto_depIdxs = nil
}
