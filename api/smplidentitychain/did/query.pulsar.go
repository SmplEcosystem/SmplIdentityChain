...
func init() {
	file_smplidentitychain_did_query_proto_init()
	md_QueryResolveDidRequest = File_smplidentitychain_did_query_proto.Messages().ByName("QueryResolveDidRequest")
...
func (x *fastReflection_QueryResolveDidRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "smplidentitychain.did.QueryResolveDidRequest.did":
		return x.Did != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: smplidentitychain.did.QueryResolveDidRequest"))
		}
		panic(fmt.Errorf("message smplidentitychain.did.QueryResolveDidRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryResolveDidRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message smplidentitychain.did.QueryResolveDidRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryResolveDidRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "smplidentitychain.did.QueryResolveDidRequest.did":
		panic(fmt.Errorf("field did of message smplidentitychain.did.QueryResolveDidRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: smplidentitychain.did.QueryResolveDidRequest"))
		}
...
func (x *fastReflection_QueryResolveDidRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in smplidentitychain.did.QueryResolveDidRequest", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_QueryResolveDidResponse_sequence              protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_QueryResolveDidResponse_sequence = md_QueryResolveDidResponse.Fields().ByName("sequence")
}
...
func (x *fastReflection_QueryResolveDidResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Sequence != uint64(0) {
		...
		if !f(fd_QueryResolveDidResponse_sequence, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryResolveDidResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "smplidentitychain.did.QueryResolveDidResponse.sequence":
...
func (x *fastReflection_QueryResolveDidResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "smplidentitychain.did.QueryResolveDidResponse.sequence":
		panic(fmt.Errorf("field sequence of message smplidentitychain.did.QueryResolveDidResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: smplidentitychain.did.QueryResolveDidResponse"))
		}
...
func (x *QueryResolveDidResponse) GetSequence() uint64 {
	if x != nil {
		return x.Sequence
	}
	return 0
...
var file_smplidentitychain_did_query_proto_rawDesc = []byte{
	...
	0x64, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x69, 0x64, 0x22, 0xbd,
	...
	0x74, 0x61, 0x12, 0x1a, 0x0a, 0x08, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x32, 0xdb,
	0x02, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x94, 0x01, 0x0a, 0x06, 0x50, 0x61, 0x72,
	0x61, 0x6d, 0x73, 0x12, 0x29, 0x2e, 0x73, 0x6d, 0x70, 0x6c, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x64, 0x69, 0x64, 0x2e, 0x51, 0x75, 0x65, 0x72,
	...
	0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x33, 0x82, 0xd3, 0xe4, 0x93,
	0x02, 0x2d, 0x12, 0x2b, 0x2f, 0x53, 0x6d, 0x70, 0x6c, 0x45, 0x63, 0x6f, 0x73, 0x79, 0x73, 0x74,
	0x65, 0x6d, 0x2f, 0x53, 0x6d, 0x70, 0x6c, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x43,
	0x68, 0x61, 0x69, 0x6e, 0x2f, 0x64, 0x69, 0x64, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12,
	0xba, 0x01, 0x0a, 0x11, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x44, 0x69, 0x64, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2d, 0x2e, 0x73, 0x6d, 0x70, 0x6c, 0x69, 0x64, 0x65, 0x6e,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x2e, 0x2e, 0x73, 0x6d, 0x70, 0x6c, 0x69, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x64, 0x69, 0x64, 0x2e, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x44, 0x69, 0x64, 0x52, 0x65, 0x73, 0x70,
